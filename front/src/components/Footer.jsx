      ...
      <div className="section__inner">
        <div className="footer__grid">
          <div className="footer__brand">
            <span className="footer__logo">GSD</span>
            <p>GOOD START DOMICILIATION</p>
            <p className="footer__tagline">
              Votre partenaire pour réussir vos débuts
            </p>
        ...
        <div className="footer__bottom">
          <p>&copy; {new Date().getFullYear()} GOOD START DOMICILIATION. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  )
